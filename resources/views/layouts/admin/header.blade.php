<header x-data="{ menuToggle: false }"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-2 py-2 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-2 dark:border-gray-800">
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="text-theme-sm mr-1 block font-medium"> {{ $auth->first_name }} </span>
