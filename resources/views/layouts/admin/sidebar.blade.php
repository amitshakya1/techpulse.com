<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[72px]' : '-translate-x-full'"
    ...
    <!-- Sidebar Header -->
    <div class="flex items-center justify-center px-4 py-3 border-b border-gray-200 dark:border-gray-700">
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        <!-- Sidebar Menu -->
        <nav x-data="{ selected: $persist('Dashboard') }" class="flex-1 px-3 py-4">
            <!-- Main Navigation -->
            <ul class="space-y-1">
                <!-- Dashboard -->
                <li>
                    <a href="#" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                        ...
                        <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Dashboard</span>

                        <svg :class="sidebarToggle ? 'lg:hidden' : ''"
                            class="ml-auto w-4 h-4 transition-transform duration-200"
                            :class="selected === 'Dashboard' ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div x-show="selected === 'Dashboard'" x-transition:enter="transition ease-out duration-200"
                        ...
                        <a href="index.html"
                            class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                            :class="page === 'ecommerce' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                            eCommerce
                        </a>
                    </div>
                </li>
                ...
                <li>
                    <a href="calendar.html"
                        ...
                        <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Calendar</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="profile.html"
                        ...
                        <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">User Profile</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" @click.prevent="selected = (selected === 'Forms' ? '':'Forms')"
                        ...
                        <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Forms</span>
                    ...
                    <!-- Dropdown -->
                    <div x-show="selected === 'Forms'" x-transition:enter="transition ease-out duration-200"
                        x-transition:enter-start="opacity-0 transform scale-95"
                        x-transition:enter-end="opacity-100 transform scale-100"
                        x-transition:leave="transition ease-in duration-150"
                        x-transition:leave-start="opacity-100 transform scale-100"
                        ...
                        <a href="form-elements.html"
                            class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                            :class="page === 'formElements' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                            Form Elements
                        </a>
                    </div>
                </li>
                ...
                <li>
                    <a href="#" @click.prevent="selected = (selected === 'Tables' ? '':'Tables')"
                        ...
                        <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Tables</span>

                        <svg :class="sidebarToggle ? 'lg:hidden' : ''"
                            class="ml-auto w-4 h-4 transition-transform duration-200"
                            :class="selected === 'Tables' ? 'rotate-180' : ''" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <!-- Dropdown -->
                    <div x-show="selected === 'Tables'" x-transition:enter="transition ease-out duration-200"
                        x-transition:enter-start="opacity-0 transform scale-95"
                        x-transition:enter-end="opacity-100 transform scale-100"
                        x-transition:leave="transition ease-in duration-150"
                        x-transition:leave-start="opacity-100 transform scale-100"
                        ...
                        <a href="basic-tables.html"
                            class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                            :class="page === 'basicTables' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                            Basic Tables
                        </a>
                    </div>
                </li>
                ...
                <li>
                    <a href="#" @click.prevent="selected = (selected === 'Pages' ? '':'Pages')"
                        ...
                        :class="(selected === 'Pages') || (page === 'fileManager' || page === 'pricingTables' ||
                            ...
                            page === 'comingSoon' || page === 'maintenance') ?
                        'bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-white' :
                        'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white'">
                        ...
                        <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Pages</span>

                        <svg :class="sidebarToggle ? 'lg:hidden' : ''"
                            class="ml-auto w-4 h-4 transition-transform duration-200"
                            :class="selected === 'Pages' ? 'rotate-180' : ''" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <!-- Dropdown -->
                    <div x-show="selected === 'Pages'" x-transition:enter="transition ease-out duration-200"
                        x-transition:enter-start="opacity-0 transform scale-95"
                        x-transition:enter-end="opacity-100 transform scale-100"
                        x-transition:leave="transition ease-in duration-150"
                        x-transition:leave-start="opacity-100 transform scale-100"
                        ...
                        <a href="blank.html"
                            class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                            :class="page === 'blank' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                            Blank Page
                        </a>
                        <a href="404.html"
                            class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                            :class="page === 'page404' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                            404 Error
                        </a>
                    </div>
                </li>
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Charts' ? '':'Charts')"
                            ...
                            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Charts</span>

                            <svg :class="sidebarToggle ? 'lg:hidden' : ''"
                                class="ml-auto w-4 h-4 transition-transform duration-200"
                                :class="selected === 'Charts' ? 'rotate-180' : ''" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <!-- Dropdown -->
                        <div x-show="selected === 'Charts'" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 transform scale-95"
                            x-transition:enter-end="opacity-100 transform scale-100"
                            x-transition:leave="transition ease-in duration-150"
                            x-transition:leave-start="opacity-100 transform scale-100"
                            ...
                            <a href="line-chart.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'lineChart' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Line Chart
                            </a>
                            <a href="bar-chart.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'barChart' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Bar Chart
                            </a>
                        </div>
                    </li>
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'UIElements' ? '':'UIElements')"
                            ...
                            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">UI Elements</span>

                            <svg :class="sidebarToggle ? 'lg:hidden' : ''"
                                class="ml-auto w-4 h-4 transition-transform duration-200"
                                :class="selected === 'UIElements' ? 'rotate-180' : ''" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <!-- Dropdown -->
                        <div x-show="selected === 'UIElements'" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 transform scale-95"
                            x-transition:enter-end="opacity-100 transform scale-100"
                            x-transition:leave="transition ease-in duration-150"
                            x-transition:leave-start="opacity-100 transform scale-100"
                            ...
                            <a href="alerts.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'alerts' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Alerts
                            </a>
                            <a href="avatars.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'avatars' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Avatars
                            </a>
                            <a href="badge.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'badge' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Badges
                            </a>
                            <a href="buttons.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'buttons' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Buttons
                            </a>
                            <a href="images.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'images' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Images
                            </a>
                            <a href="videos.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'videos' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Videos
                            </a>
                        </div>
                    </li>
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Authentication</span>

                            <svg :class="sidebarToggle ? 'lg:hidden' : ''"
                                class="ml-auto w-4 h-4 transition-transform duration-200"
                                :class="selected === 'Authentication' ? 'rotate-180' : ''" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <!-- Dropdown -->
                        <div x-show="selected === 'Authentication'"
                            ...
                            <a href="signin.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'signin' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Sign In
                            </a>
                            <a href="signup.html"
                                class="group flex items-center px-3 py-2 ml-6 text-sm text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                                :class="page === 'signup' ? 'bg-gray-50 text-gray-900 dark:bg-gray-800 dark:text-white' : ''">
                                Sign Up
                            </a>
                        </div>
                    </li>
    ...
    <!-- Settings Button -->
    <div class="px-3 py-1 border-t border-gray-200 dark:border-gray-700">
        <button
            class="flex w-full items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white transition-colors duration-200">
            <svg class="flex-shrink-0 w-5 h-5 mr-3 text-gray-500 dark:text-gray-400" fill="currentColor"
                viewBox="0 0 24 24">
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M12 2C11.5858 2 11.25 2.33579 11.25 2.75V12C11.25 12.4142 11.5858 12.75 12 12.75H21.25C21.6642 12.75 22 12.4142 22 12C22 6.47715 17.5228 2 12 2ZM12.75 11.25V3.53263C13.2645 3.57761 13.7659 3.66843 14.25 3.80098V3.80099C15.6929 4.19606 16.9827 4.96184 18.0104 5.98959C19.0382 7.01734 19.8039 8.30707 20.199 9.75C20.3316 10.2341 20.4224 10.7355 20.4674 11.25H12.75ZM2 12C2 7.25083 5.31065 3.27489 9.75 2.25415V3.80099C6.14748 4.78734 3.5 8.0845 3.5 12C3.5 16.6944 7.30558 20.5 12 20.5C15.9155 20.5 19.2127 17.8525 20.199 14.25H21.7459C20.7251 18.6894 16.7492 22 12 22C6.47715 22 2 17.5229 2 12Z" />
            </svg>
            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="truncate">Settings</span>
        </button>
    </div>
</aside>
